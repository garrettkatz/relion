#ifndef SAS_CUDA_ML_OPTIMISER_H_
#define SAS_CUDA_ML_OPTIMISER_H_
...
public:
	...
	SasMlDeviceBundle(SasMlOptimiser *baseMLOptimiser):
...
public:
   ...
   //Class streams ( for concurrent scheduling of class-specific kernels)
	...
	SasMlOptimiserCuda(SasMlOptimiser *baseMLOptimiser, SasMlDeviceBundle* bundle, const char * timing_fnm) :
			baseMLO(baseMLOptimiser),
